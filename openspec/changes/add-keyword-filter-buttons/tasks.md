...
- [x] 4.1 爬取資料後，點擊「設備」按鈕確認只顯示標案名稱含「設備」的列
- [x] 4.2 同時啟用「設備」與「機房」，確認顯示命中任一關鍵字的列
- [x] 4.3 再次點擊啟用中的按鈕，確認取消篩選、顯示正確更新
- [x] 4.4 全部按鈕取消後確認顯示全部資料
- [x] 4.5 在篩選狀態下點擊「下載 CSV」，確認下載的 CSV 只含篩選後的列
